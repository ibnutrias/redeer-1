...
// node_modules/.pnpm/@heyputer+kv.js@0.2.1/node_modules/@heyputer/kv.js/XMap.js
var require_XMap = __commonJS({
  "node_modules/.pnpm/@heyputer+kv.js@0.2.1/node_modules/@heyputer/kv.js/XMap.js"(exports2, module2) {
    "use strict";
    var XMap = class {
      #pool;
      /**
...
// node_modules/.pnpm/@heyputer+kv.js@0.2.1/node_modules/@heyputer/kv.js/kv.js
var require_kv = __commonJS({
  "node_modules/.pnpm/@heyputer+kv.js@0.2.1/node_modules/@heyputer/kv.js/kv.js"(exports2, module2) {
    "use strict";
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/index.js
var import_kv = __toESM(require_kv());

// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/APICallLogger.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/path.js
var cwd;
var CHAR_DOT = 46;
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/polyfills/localStorage.js
var root = {};
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/polyfills/xhrshim.js
var sReadyState = /* @__PURE__ */ Symbol("readyState");
var sHeaders = /* @__PURE__ */ Symbol("headers");
var sRespHeaders = /* @__PURE__ */ Symbol("response headers");
var sAbortController = /* @__PURE__ */ Symbol("AbortController");
var sMethod = /* @__PURE__ */ Symbol("method");
var sURL = /* @__PURE__ */ Symbol("URL");
var sMIME = /* @__PURE__ */ Symbol("MIME");
var sDispatch = /* @__PURE__ */ Symbol("dispatch");
var sErrored = /* @__PURE__ */ Symbol("errored");
var sTimeout = /* @__PURE__ */ Symbol("timeout");
var sTimedOut = /* @__PURE__ */ Symbol("timedOut");
var sIsResponseText = /* @__PURE__ */ Symbol("isResponseText");
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/polyfills/fileReaderPoly.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/UsageLimitDialog.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/EmailConfirmationDialog.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/utils.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/AI.js
...
var AI = class {
  ...
  constructor(puter3) {
    this.puter = puter3;
    this.authToken = puter3.authToken;
    this.APIOrigin = puter3.APIOrigin;
    this.appID = puter3.appID;
  }
  /**
...
`;
  ...
  txt2vid = async (...args) => {
    ...
    const looksLikeTogetherVideoModel = typeof options.model === "string" && (TOGETHER_VIDEO_MODEL_PREFIXES.some((prefix) => modelLower.startsWith(prefix)) || options.model.startsWith("togetherai:"));
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Apps.js
var Apps = class {
  /**
   * Creates a new instance with the given authentication token, API origin, and app ID,
   *
  ...
  getDeveloperProfile = function(...args) {
    ...
    return new Promise((resUpper, rejUpper) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        setupXhrEventHandlers(xhr, options2.success ?? resUpper, options2.error ?? rejUpper, resolve, reject);
        xhr.send();
      });
    });
  };
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Auth.js
var Auth = class {
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Debug.js
var Debug = class {
  constructor(puter3, parameters) {
    this.puter = puter3;
  ...
  _init() {
    ...
    globalThis.addEventListener("message", async (e2) => {
      ...
      if (e2.data.cmd === "log.on") {
        ...
        this.puter.logger.on(e2.data.category);
      }
    });
  }
};

// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Drivers.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/socket.io/socket.io.esm.min.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FSItem.js
var FSItem = class {
  constructor(options) {
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/utils/getAbsolutePathForApp.js
var getAbsolutePathForApp = (relativePath) => {
  ...
  if (!relativePath || !relativePath.startsWith("/") && !relativePath.startsWith("~")) {
    if (puter.appID) {
      ...
      relativePath = path_default.join("~/", relativePath);
    }
  }
  return relativePath;
};
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/copy.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/deleteFSEntry.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/stat.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/getReadUrl.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/mkdir.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/move.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/read.js
var read = function(...args) {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    options.path = getAbsolutePathForApp_default(options.path);
    const xhr = initXhr(`/read?${new URLSearchParams({ file: options.path, ...options.offset ? { offset: options.offset } : {}, ...options.byte_count ? { byte_count: options.byte_count } : {} }).toString()}`, this.APIOrigin, this.authToken, "get", "application/json;charset=UTF-8", "blob");
    setupXhrEventHandlers(xhr, options.success, options.error, resolve, reject);
    xhr.send();
  });
};
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/readdir.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/readdirSubdomains.js
...
var readdirSubdomains_default = readdirSubdomains;

// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/rename.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/revokeReadUrl.js
...
var revokeReadUrl_default = revokeReadURL;

// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/sign.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/space.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/symlink.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/upload.js
  ...
  return new Promise(async (resolve, reject) => {
    ...
    if (!options.shortcutTo) {
      for (let i2 = 0; i2 < files.length; i2++) {
        const thumbnail = thumbnails[i2] ?? options.thumbnail ?? void 0;
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/write.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/FileSystem/index.js
...
var PuterJSFileSystemModule = class {
  ...
  revokeReadURL = revokeReadUrl_default;
  readdir = readdir_default;
  readdirSubdomains = readdirSubdomains_default;
  stat = stat_default;
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Hosting.js
var Hosting = class {
  /**
   * Creates a new instance with the given authentication token, API origin, and app ID,
   *
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/KV.js
var createDeferred2 = () => {
  let resolve;
  let reject;
  const promise = new Promise((res, rej) => {
...
var KV = class {
  ...
  constructor(puter3) {
    ...
    this.APIOrigin = puter3.APIOrigin;
    this.appID = puter3.appID;
    this.gui_cached = createDeferred2();
    this.gui_cache_init = createDeferred2();
    (async () => {
  ...
  async get(...args) {
    if (typeof args[0] === "string" && gui_cache_keys.includes(args[0]) && this.gui_cached !== null) {
      ...
      const cache2 = await this.gui_cached.promise;
  ...
  add = async (...args) => {
    ...
    options.pathAndValueMap = provided === void 0 ? { "": 1 } : isPathMap ? provided : { "": provided };
    if (options.key.length > this.MAX_KEY_SIZE) {
      throw { message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`, code: "key_too_large" };
    }
  ...
  remove = async (...args) => {
    ...
    if (paths.some((path2) => typeof path2 !== "string")) {
      throw { message: "All paths must be strings", code: "paths_invalid" };
    }
    return make_driver_method(["key", "paths"], "puter-kvstore", void 0, "remove").call(this, { key, paths });
  };
  update = make_driver_method(["key", "pathAndValueMap", "ttl"], "puter-kvstore", void 0, "update", {
    preprocess: (args) => {
      if (args.key === void 0 || args.key === null) {
        throw { message: "Key cannot be undefined", code: "key_undefined" };
      }
      ...
      if (args.pathAndValueMap === void 0 || args.pathAndValueMap === null || Array.isArray(args.pathAndValueMap) || typeof args.pathAndValueMap !== "object") {
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/EventListener.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/networking/parsers.js
var CONNECT = 1;
var DATA = 2;
var CONTINUE = 3;
var CLOSE = 4;
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/networking/PWispHandler.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/networking/PSocket.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/networking/PTLS.js
var rustls = void 0;
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/networking/requests.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/OS.js
var OS = class {
  /**
   * Creates a new instance with the given authentication token, API origin, and app ID,
   *
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Perms.js
var Perms = class {
  constructor(puter3) {
    this.puter = puter3;
    this.authToken = puter3.authToken;
  ...
  async req_(route, body) {
    try {
      ...
      return { error: true, message: e2.message, code: "internal_error" };
    }
  }
  // Grant Permissions
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/PuterDialog.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/UI.js
var createDeferred3 = () => {
  let resolve;
  let reject;
  const promise = new Promise((res, rej) => {
...
var FILE_SAVE_CANCELLED = /* @__PURE__ */ Symbol("FILE_SAVE_CANCELLED");
var FILE_OPEN_CANCELLED = /* @__PURE__ */ Symbol("FILE_OPEN_CANCELLED");
var AppConnection = class _AppConnection extends EventListener {
  ...
  #usesSDK;
  static from(values, puter3, { messageTarget, appInstanceID }) {
    const connection = new _AppConnection(puter3, {
  ...
  constructor(puter3, { target, usesSDK, messageTarget, appInstanceID }) {
    super([
      "message",
    ...
    this.log = puter3.logger.fields({
      category: "ipc"
    });
    this.log.fields({
      cons_source: appInstanceID,
      source: puter3.appInstanceID,
      target
...
var UI = class extends EventListener {
  ...
  #postMessageWithCallback(name, resolve, args = {}) {
    ...
    this.#callbackFunctions[msg_id] = (...a2) => {
      resolve(...a2);
    };
  }
  ...
  constructor(puter3, { appInstanceID, parentInstanceID }) {
    const eventNames = [
      "localeChanged",
      "themeChanged",
      "connection"
    ...
    globalThis.document && window.addEventListener("message", async (e2) => {
      ...
      if (e2.data.error) {
        ...
        if (e2.data.msg === "fileOpenPicked") {
          ...
          this.#callbackFunctions[e2.data.original_msg_id](e2.data.response);
        } else if (e2.data.msg === "notificationShown") {
          this.#callbackFunctions[e2.data.original_msg_id](e2.data.uid);
        ...
        const conn = AppConnection.from(e2.data, this.puter, {
          messageTarget: this.messageTarget,
          appInstanceID: this.appInstanceID
        });
        const accept = (value) => {
  ...
  notify(options) {
    return new Promise((resolve) => {
      ...
      if (normalized.roundIcon !== void 0 && normalized.round_icon === void 0) {
  ...
  showOpenFilePicker(options, callback) {
    const undefinedOnCancel = createDeferred3();
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/lib/xdrpc.js
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Util.js
var Util = class {
  constructor() {
...
// node_modules/.pnpm/@heyputer+puter.js@2.2.11/node_modules/@heyputer/puter.js/src/modules/Workers.js
...
var SimpleLogger = class _SimpleLogger {
  ...
  fields(extra = {}) {
    return new _SimpleLogger({ ...this.fieldsObj, ...extra });
  }
  info(...args) {
    ...
    constructor() {
      ...
      (async () => {
        try {
          ...
          const prefix = `[${whoami?.app_name ?? this.appInstanceID ?? "HOST"}]`;
...
puter2.runWhenPuterHappensCallbacks();
puter2.tools = [];
